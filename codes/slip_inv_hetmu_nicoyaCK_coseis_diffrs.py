...
if not BOUNDED:
    ...
    gammas_s = [8e1, 2e2, 4e2, 6e2, 8e2, 2e3]   # extra added
...
if BOUNDED:
    outFileName = f"Lcurvecoseisbd_rs{rho_s:.1e}_{meshname}_{mu_str_inv}.txt"
else:
    outFileName = f"Lcurvecoseis_rs{rho_s:.1e}_{meshname}_{mu_str_inv}.txt"
