...
# 
# * Use the slab geometry from slab2.0, and use the slab/wedge contrast shear modulus model.
# 
...
#         savefiles=True, verbose=True
#     )
#     print("Het Inversion with slip bounds finished!!!")
