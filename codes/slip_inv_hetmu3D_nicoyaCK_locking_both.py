...
# 
# * Use the slab geometry from Kyriakopoulos et al. (2015), and use the 3D shear modulus model from DeShon et al. (2006)
# 
...
if not BOUNDED:
    ...
    # gammas_s = [2e2, 4e2, 6e2, 8e2, 1e3, 2e3, 4e3, 1e4, 5e4]
    ...
    # gammas_s = [2e3, 3e3, 4e3, 1e4, 5e4]   # remaining
