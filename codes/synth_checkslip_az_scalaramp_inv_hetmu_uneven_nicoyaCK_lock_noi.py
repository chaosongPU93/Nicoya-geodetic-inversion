# %% [markdown]
# # Synthetic recovery test — Az-constrained SCALAR amplitude inversion (HET forward, CHECKERBOARD)
#
# Checkerboard variant of synth_stripeslip_az_scalaramp_inv_hetmu_uneven_nicoyaCK_lock_noi.py.
# Based on synth_checkslip_az_inv_hetmu_uneven_nicoyaCK_lock_noi.py (reference).
# Counterpart to synth_checkslip_az_scalaramp_inv_hetmu_uneven_nicoyaCK_lock_noi2.py
