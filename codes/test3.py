...
m0_s_expr = dl.Constant((0.1, 0.1))   # tanh(0)=0, tanh(1)=0.76
...
# file identifier
if BOUNDED:
    inv_str = f"_m0lockbothbd_w{w_h}{w_v}_gs{gamma_val_H1:.0e}_ds{delta_val_L2:.0e}"
else:
    inv_str = f"_m0lockboth_w{w_h}{w_v}_gs{gamma_val_H1:.0e}_ds{delta_val_L2:.0e}"
