# %% [markdown]
# # Slip inversion of the GNSS coseismic displacement measurements of 2012 Nicoya (Costa Rica) Mw7.6 EQ within a homogeneous half-space
# 
...
# note that the height is in m, duration and dates are in yr, and the displacements and errors are already in mm
...
def solveCoseismicInversion(k, targets, m0_s_expr, gamma_val_H1, delta_val_L2, savefiles=True, verbose=True):
    ...
    solver.parameters["abs_tolerance"] = 1e-15 
