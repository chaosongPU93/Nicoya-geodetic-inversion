...
if not BOUNDED:
    ...
    # gammas_s = [1.5e2]
    gammas_s = [2e2]   # re-run after .0e→.1e rename (was overwritten by γ=2.5e2)
...
# ---- L-curve append DISABLED for this re-run (γ row already exists; would duplicate). ----
# Restore: uncomment the 4 lines below.
