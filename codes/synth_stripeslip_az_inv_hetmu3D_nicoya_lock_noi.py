# %% [markdown]
# Az version of 'synth_stripeslip_inv_hetmu3D_nicoya_lock_noi.py'.
...
# Het+Hom single runs active; L-curves not needed and commented out.
#
...
slip_pattern = "stripe"   # along-strike stripes
...
if slip_pattern == "checker":
    ...
    if pattern_option == 1:
        # Stripe pattern, 2-stripe, shallow-deep
        ...
        # Stripe pattern, 1-stripe, complementary to option 1
...
if not BOUNDED:
    if meshname == "nicoya4":      # extended fault area
        # gamma_val_H1 = 1e3  
        # delta_val_L2 = 1e-4
        # delta_val_L2 = 1e-5
        # gamma_val_H1 = 2.5e3  
    ...
    if meshname == "nicoya3":       # small fault connecting trench
...
# # %%
# ### Single run — Az version (no L-curve needed) ###

# import gc  # for explicit memory management

# # Default gamma for nicoyaden_sm (not in mesh-specific conditionals above)
# gamma_val_H1 = 2.5e2
# rho_s = 1e9
# delta_val_L2 = gamma_val_H1 / rho_s
...
# %%
## L-curve criterion — not needed for Az version, commented out ###
import gc
