# %% [markdown]
# # Synthetic forward (Az-consistent) — CHECKERBOARD
#
# Based on: synth_checkslip_az_scalaramp_inv_hetmu_uneven_nicoyaCK_lock_noi2.py
#
...
sep = "\n"+"#"*80+"\n"
print(sep, "START of Az-consistent forward (checkerboard)", sep)
