# %% [markdown]
# # Synthetic forward (Az-consistent) — CHECKERBOARD, 3D
#
# Based on: synth_stripe_az_consistfwd_3D_nicoyaCK.py (3D stripe) + synth_check_az_consistfwd_nicoyaCK.py
#
...
sep = "\n"+"#"*80+"\n"
print(sep, "START of Az-consistent forward (checkerboard, 3D DeShon)", sep)
...
if not RUN_LCURVE:
    ...
    print(sep, "SINGLE TEST RUN — Az scalar amplitude inversion (consistent forward, 3D checker)", sep)
...
if RUN_LCURVE:
    ...
    _passes = [
        ("Het 3D L-curve (priority)", gammas_s_priority1, outFileName_het, mtrue_mu_expr_het,
