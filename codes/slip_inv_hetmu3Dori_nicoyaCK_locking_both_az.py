# %% [markdown]
# # Back-slip inversion with direction constrained to plate motion azimuth (3D mu, ORIGINAL / unscaled)
#
# Based on slip_inv_hetmu3D_nicoyaCK_locking_both_az.py — sibling that uses the
# UNSCALED DeShon 3D shear modulus (contrast_factor = 1.0, no amplification).
#
...
# artifacts). NO amplification (contrast_factor = 1.0) — the "ref global mean"
# string is used in filenames: _DeShon3D_ref_1_hull (no _ref1D_ suffix).
#
