# %% [markdown]
# # Synthetic forward (Az-consistent) + scalar amplitude inversion — STRIPE, Het μ
#   nicoyaden_sm mesh (Slab2.0 plate interface), azi_equidist_proj coordinates.
#
# Based on: synth_stripe_az_consistfwd_nicoya.py   (Hom CF strategy)
#           synth_stripe_az_consistfwd_het_nicoyaCK.py  (Het μ structure)
#
# PURPOSE: Run the AzSlip-consistent forward (Het μ) + scalar amplitude inversion
#          on the nicoyaden_sm mesh. Het: right block stiffer, left block softer.
#          Inversion tested under both Het and Hom μ assumptions (2-pass L-curve).
#
...
sep = "\n"+"#"*80+"\n"
print(sep, "START of Az-consistent forward + scalar amplitude inversion (stripe, Het mu, nicoyaden_sm)", sep)
...
if RUN_LCURVE:
    ...
    # Order: Het priority → Hom priority
