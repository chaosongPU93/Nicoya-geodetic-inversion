# %% [markdown]
# # Synthetic forward (Az-consistent) — STRIPE, Heterogeneous μ
#
# Based on: synth_stripeslip_az_scalaramp_inv_hetmu_uneven_nicoyaCK_lock_noi.py
#
# PURPOSE: Test the AzSlip-consistent forward scheme with K_2LAYER heterogeneous
# shear modulus (upper=25 GPa, lower=55 GPa). Het counterpart to
# synth_stripe_az_consistfwd_nicoyaCK.py (Hom case).
#
...
#   Inversion: Reads d_obs_cf_* (consistent-forward data); runs Het and Hom L-curves
#
# FORWARD MU: K_2LAYER het mu (upper=25 GPa, lower=55 GPa)
#
# CONTRAST WITH ORIGINAL FORWARD:
#   Original: create_fault_local_stripes_az → 2-comp vector in GLOBAL frame
...
sep = "\n"+"#"*80+"\n"
print(sep, "START of Az-consistent forward (stripe, Het)", sep)
...
def solveCoseismicForward_AzConsistent(k, targets, mtrue_mu_expr_for,
    ...
    if savefiles:
        ...
        mu_id.close()   # CRITICAL: leaking handle hangs MUMPS at next L-curve iteration
...
# %%
# ============================================================
# SINGLE TEST RUN — Het μ, Az scalar amplitude inversion (consistent forward)
# ============================================================
if not RUN_LCURVE:
    gamma_s = 1.5e2
