...
def solveCoseismicForward(k, targets, mtrue_mu_expr_for, mtrue_s_expr=None, pollute=True, \
    ...
    if pollute:
        ...
        # seed_num = (pattern_option-1)*20+2    #for testing, not actually used
...
# %%
def computeSurfaceDisplacements(k, targets, mtrue_mu_expr_for, mtrue_s_expr=None, pollute=False, \
                          pollute_type='uniform', savefiles=True, verbose=True):
    """
...
computeSurfaceDisplacements(k, targets_grid, mtrue_mu_expr_for, mtrue_s_expr=mtrue_s_expr_for, \
