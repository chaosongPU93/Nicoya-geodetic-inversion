# %% [markdown]
# This is a duplicate of 'synth_checkslip_inv_hetmu_nicoyaCK_lock_noi.py' with limited changes to test
...
# Both Het and Hom single runs enabled. L-curves added for future usage but commented out.
