# %% [markdown]
# # Synthetic recovery test — Az-constrained SCALAR amplitude inversion
#   Nicoya dense mesh (nicoyaden_sm), even top boundary, stripe pattern, Hom μ only.
#
# Based on synth_stripeslip_az_inv_hetmu_nicoya_lock_noi2.py (reference Az TanhSlip)
# and synth_stripeslip_az_scalaramp_inv_hetmu_uneven_nicoyaCK_lock_noi2.py (AzSlip).
#
...
#   - Forward:     identical to reference (solveCoseismicForward); call commented out
...
# Define sep
sep = "\n"+"#"*80+"\n"
print(sep, "START of Az scalar-amplitude synth recovery test (nicoyaden_sm)", sep)
...
# %%
# Forward shear modulus (homogeneous for synthetics)
...
# (synth_stripeslip_az_inv_hetmu_nicoya_lock_noi2.py with same parameters)
