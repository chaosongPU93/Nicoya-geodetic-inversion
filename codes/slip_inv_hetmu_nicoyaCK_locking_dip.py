...
obs_disp_name = "CKfig5_data_final.csv"   # the EXACT data file for figure 5 in Kyriakopoulos et al. (2016)
...
# file identifier
if BOUNDED:
    inv_str = f"_lockdipbd_w{w_h}{w_v}_gs{gamma_val_H1:.0e}_ds{delta_val_L2:.0e}"
else:
    inv_str = f"_lockdip_w{w_h}{w_v}_gs{gamma_val_H1:.0e}_ds{delta_val_L2:.0e}"
