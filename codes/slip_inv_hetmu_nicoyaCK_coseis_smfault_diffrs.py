...
# rho_s = 2e7   # allows variations of slip of the order of ~15 km, close to the maximum resolution
...
# if not BOUNDED:
#     # gammas_s = [1e2]    #best, in terms of reproducing CK's results
#     # gammas_s = [2.5e2]
#     # gammas_s = [2e1, 4e1, 8e1, 1e2, 2e2, 4e2, 8e2, 2e3, 1e4]
#     # gammas_s = [2.5e1, 5e1, 7.5e1, 1e2, 2.5e2, 5e2, 1e3, 5e3, 1e4]
#     # gammas_s = [5e1, 1e2, 2e2, 8e1]
#     # gammas_s = [6e2]    # extra fining
#     # gammas_s = [5e2, 7e2, 9e2]    # more extra fining!
#     gammas_s = [4e1, 8e1, 1e2, 2e2, 4e2, 5e2, 6e2, 7e2, 8e2, 9e2, 2e3, 1e4]   # extra added
