# %% [markdown]
# Az version of 'synth_checkslip_inv_hetmu_uneven_nicoyaCK_lock_noi2.py'.
...
# Hom single run only (no Het). L-curves commented out.
...
if BOUNDED:
    ...
    # gammas_s = [1e2]  # more testing
    gammas_s = [1.2e2]  # more testing
