# %% [markdown]
# Az version of 'synth_stripeslip_inv_hetmu3D_uneven_nicoyaCK_lock_noi.py'.
# Slip is prescribed in a fixed geographic azimuth direction (45° CW from North) using
# FaultLocalStripesAz / FaultLocalCheckerboardAz, with per-facet (c_strike, c_dip) computed
