# %% [markdown]
# # Synthetic forward (Az-consistent) — STRIPE
#
# Based on: synth_stripeslip_az_scalaramp_inv_hetmu_uneven_nicoyaCK_lock_noi2.py
#
...
sep = "\n"+"#"*80+"\n"
print(sep, "START of Az-consistent forward (stripe)", sep)
...
# ============================================================
if RUN_LCURVE:
    # Priority gammas (likely at the L-curve corner — run first)
    # gammas_s_priority = [1e2, 1.2e2, 1.5e2, 1.8e2, 2e2]
    # gammas_s_priority = [1.5e2, 1.8e2]
    # Remaining gammas (needed for full L-curve plot — run after priority)
    ...
    _passes = [
        ...
        ("Hom L-curve (rest)",     gammas_s_rest,     outFileName, mtrue_mu_expr_hom, mu_str_hom),
    ]
