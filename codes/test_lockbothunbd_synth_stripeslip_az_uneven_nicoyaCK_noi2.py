...
# gammas_s = [1e3, 2e3, 3e3]  # rough testing
# gammas_s = [4e3, 6e3, 8e3, 1e4]  # rough testing
# gammas_s = [2e3, 4e3, 1e3]  # rough testing
gammas_s = [3e3]  # rough testing
...
if BOUNDED:
    outFileName = f"Lcurvesynlockbd_testazbd_rs{rho_s:.0e}_{meshname}_{slip_pattern}_{pattern_option}_{mu_str_for}_{mu_str_inv}.txt"
else:
    outFileName = f"Lcurvesynlock_testaz_rs{rho_s:.0e}_{meshname}_{slip_pattern}_{pattern_option}_{mu_str_for}_{mu_str_inv}.txt"
