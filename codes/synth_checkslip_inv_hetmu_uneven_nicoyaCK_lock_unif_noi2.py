# %% [markdown]
# This is a duplicate of 'synth_checkslip_inv_hetmu_nicoyaCK_lock_noi2.py' with limited changes to test
...
# if BOUNDED:
#     # gammas_s = [2.5e1]
#     # gammas_s = [2e0, 4e0, 8e0, 1e1, 2e1, 4e1, 8e1, 1e2, 1e3]  #full range

#     ###by 12/03, 2e0 and 4e0 have finished, and 2e0 may be too small (>500 it)
#     ###nohup python synth_checkslip_inv_hetmu_nicoyaCK_lock_noi2.py | tee -a log_syncheck1_lcrs1e9 2>&1 &nohup python synth_checkslip_inv_hetmu_nicoyaCK_lock_noi2.py | tee -a log_syncheck1_lcrs1e9 2>&1 &
#     gammas_s = [8e0, 1e1, 2e1, 4e1, 8e1, 1e2, 1e3]
...
#     # file identifier
#     if BOUNDED:
#         inv_str = f"_synlockbd_w{w_h}{w_v}_gs{gamma_s:.0e}_ds{delta_s:.0e}"
#     else:
#         inv_str = f"_synlock_w{w_h}{w_v}_gs{gamma_s:.0e}_ds{delta_s:.0e}"
#     print("Inverse problem identifier: ", inv_str)
