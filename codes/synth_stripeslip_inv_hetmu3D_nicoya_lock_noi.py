...
if BOUNDED:
    ...
    # gammas_s = [2e1, 4e1, 6e1, 8e1, 1e2, 2e2, 4e2, 1e3, 1e4]    # actually used
    # gammas_s = [1e-1, 1e0, 1e1, 3e1, 1e2, 3e2, 1e3, 3e3, 1e4]   # suggested by chatGPT
    # gammas_s = [3e2]  # extra fining
    gammas_s = [2.5e2, 2e2, 2.2e2, 3e2, 3.5e2]  # more extra finings
...
# csvoutput = open(resultpath + outFileName + '_extra', 'a') # make new and overwrite
