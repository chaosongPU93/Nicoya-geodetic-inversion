# %% [markdown]
# This is a duplicate of 'synth_checkslip_inv_hetmu3D_nicoyaCK_lock_noi.py' with limited changes to test
...
if BOUNDED:
    # gammas_s = [2.5e1]
    # gammas_s = [2e0, 4e0, 8e0, 1e1, 2e1, 4e1, 8e1, 1e2, 1e3]
    # gammas_s = [1e-1, 1e0, 1e1, 2e1, 3e1, 1e2, 3e2, 1e3, 1e4]   # suggested by chatGPT
    # gammas_s = [5e1, 1e2, 2e2, 8e1]
    gammas_s = [3e1, 2e1, 4e1, 1e1, 5e1]
